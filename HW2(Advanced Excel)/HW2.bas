...
Dim WS As Worksheet
    ...
    WS.Activate
'Finding last row assigning a variable
...
'Assigning all variables, NOTE assigned volume to 0 to restart
...
'LOOP
  For i = 2 To LastRow
' Checking if same ticker, IF NOT = then
...
' Setting colors, GO TO COLOR CHART
...
' Loop rows, find matching ticker
