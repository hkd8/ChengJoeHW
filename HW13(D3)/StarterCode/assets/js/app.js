...
yText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "CO2 Emissions | Electric Heat")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("CO2 Emissions | Electric Heat");

yText
  .append("text")
  .attr("y", -10)
  .attr("data-name", "CO2 Emissions | Gas Fuel")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("CO2 Emissions | Gas Fuel"); 

yText
  .append("text")
  .attr("y", -10)
  .attr("data-name", "CO2 Emissions | Liquid Fuel")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("CO2 Emissions | Liquid Fuel");   
...
yText
  ...
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("CO2 Emissions | Manufacture and Construct"); 
  
  yText
  .append("text")
  .attr("y", -52)
  .attr("data-name", "CO2 Emissions | Residential Commercial Public Service")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("CO2 Emissions | Residential Commercial Public Service");  